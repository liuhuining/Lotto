 ...
 */
public class SortFilterContentAdapter extends BaseAdapter {

    private List<HomePageResult.SortListBean.ValListBean> sortList;
    private int selectIndex = -1;

    public SortFilterContentAdapter(List<HomePageResult.SortListBean.ValListBean> sortList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        vh.textView.setText(sortList.get(position).getSortVal());
    ...
    public void clickItem(int position) {
        ...
        changeText.changeSortFilteText(sortList.get(position).getSortVal(), sortList.get(position).getSortName());
        notifyDataSetChanged();
    }

    public interface ChangeText {
        void changeSortFilteText(String string, String type);
    }
